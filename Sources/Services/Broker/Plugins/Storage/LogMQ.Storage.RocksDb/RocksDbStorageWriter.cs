...
///// </summary>
//public class RocksDbStorageWriter : ILogStorageWriter, IDisposable
//{
...
//    /// </summary>
//    private readonly ILogger<RocksDbStorageWriter> logger;
...
//    /// <summary>
//    /// Initializes a new instance of the <see cref="RocksDbStorageWriter"/> class.
//    /// </summary>
//    /// <param name="logger">An instance of <see cref="ILogger{TCategoryName}"/> for logging events.</param>
//    public RocksDbStorageWriter(ILogger<RocksDbStorageWriter> logger)
//    {
//        this.logger = logger;
//        logger.LogInformation("Init RocksDB Storage Writer");
