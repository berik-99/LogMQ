...
internal static class LogEventExtensions
{
	...
	internal static string ToJsonLogMessage(this LogEvent logEvent, IFormatProvider formatProvider, string applicationName)
		=> JsonSerializer.Serialize(logEvent.ToLogMessage(formatProvider, applicationName));
